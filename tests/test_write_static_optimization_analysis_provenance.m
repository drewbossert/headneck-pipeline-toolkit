...
function flat = localReadManifestCsv(csvFile)

    firstLine = ...
        string( ...
            extractBefore( ...
                string(fileread(csvFile)), ...
                newline));
    ...
    assert(verifyHeader, ...
        "SOAnalysisProvenanceTest:UnexpectedCsvHeader", ...
        "Unexpected provenance CSV header:\n%s", ...
        firstLine);
    ...
    assert(isempty(missingNames), ...
        "SOAnalysisProvenanceTest:MissingCsvVariables", ...
        "CSV import options did not detect required variables: %s\n" + ...
        "Detected variables: %s", ...
        strjoin(missingNames, ", "), ...
        strjoin(detectedNames, ", "));
